class CompraStorage {
    ...
    salvaCompras(listaCompras) {
        ...
        localStorage.setItem("compra", JSON.stringify(listaCompras.compras.map(compra => ({ item: compra.item, unidade: compra.unidade, data: compra.data, quantidade: compra.quantidade, valor: compra.valor }))));
    }
    removeCompras() {
